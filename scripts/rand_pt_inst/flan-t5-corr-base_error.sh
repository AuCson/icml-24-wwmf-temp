...
do
  ...
  configs/p3/instance-bart0-base-ocl/delay_opt.yaml configs/rand/inst/flan-t5-large-full-correct-be.yaml \
  --templates my_seed=${seed} --ocl_task mmlu --monitor logit_pred --base_err_only
