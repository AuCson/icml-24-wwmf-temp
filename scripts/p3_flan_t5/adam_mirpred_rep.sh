...
do
  ...
  #configs/mmlu/shards_text.yaml configs/p3/instance-bart0-base-ocl/mirpred_rep_dev_flan_t5.yaml \
  ...
  python instance_ocl_p3.py --config_files configs/p3/p3_default.yaml configs/p3/flan_mmlu_512p.yaml configs/p3/instance-bart0-base-ocl/vanilla_flan_t5_large.yaml \
  configs/mmlu/shards_text.yaml configs/p3/instance-bart0-base-ocl/mirpred_flan_t5/mirpred_rep_dev_flan_t5_no_repeat.yaml \
