...
do
  ...
  configs/mmlu/shards_text_dev.yaml configs/p3/instance-bart0-base-ocl/distill_er_flan_t5_coreset.yaml \
  ...
  --templates postfix=_evtest2_step30_f8n10_adam_full_greedy_eval_mmlu_text-lr${LR}/${TASK}/${SHARD_IDX}_${SHARD_TOTAL}/ task=${TASK} shard_idx=${SHARD_IDX} shard_total=${SHARD_TOTAL} --ocl_task ${TASK} --max_step 1000 \
  ...
  --templates postfix=_step30_l512p_adam_lora_f4n5_greedy_eval_mmlu_text-lr${LR}/${TASK}/${SHARD_IDX}_${SHARD_TOTAL}/ task=${TASK} shard_idx=${SHARD_IDX} shard_total=${SHARD_TOTAL} --ocl_task ${TASK} --max_step 1000 \
  ...
  configs/mmlu/shards_text_xl_dev.yaml configs/p3/instance-bart0-base-ocl/distill_er_flan_t5_coreset.yaml \
  ...
  configs/p3/instance-bart0-base-ocl/replay_freq5.yaml configs/p3/instance-bart0-base-ocl/replay_nstep.yaml configs/p3/instance-bart0-base-ocl/delay_opt.yaml configs/p3/flan_t5_lora.yaml \
  --templates postfix=_step30_l512p_adam_lora_f2n5_greedy_eval_mmlu_text-lr${LR}/${TASK}/${SHARD_IDX}_${SHARD_TOTAL}/ task=${TASK} shard_idx=${SHARD_IDX} shard_total=${SHARD_TOTAL} --ocl_task ${TASK} --max_step 1000 \
