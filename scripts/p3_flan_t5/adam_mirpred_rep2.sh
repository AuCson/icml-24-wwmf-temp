...
do
  ...
  do
  # vanilla
  python instance_ocl_p3.py --config_files configs/p3/p3_default.yaml configs/p3/flan_mmlu_l512p.yaml configs/p3/instance-bart0-base-ocl/vanilla_flan_t5_large.yaml \
