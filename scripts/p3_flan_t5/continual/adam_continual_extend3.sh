...
do
  ...
  LR=1e-6
  # vanilla
  python instance_ocl_p3.py --config_files configs/p3/p3_default.yaml  configs/p3/flan_mmlu.yaml configs/p3/instance-bart0-base-ocl/vanilla_flan_t5_large.yaml \
  configs/p3/instance-bart0-base-ocl/continual.yaml configs/mmlu/shuffle.yaml \
  ...
  --skip_before_eval --interval_eval 10 \
  --templates postfix=_continual_long_step30_adam_full_greedy_eval_mmlu_text-lr${LR}/${TASK}/${SHARD_IDX}_${SHARD_TOTAL}/ task=${TASK} shard_idx=${SHARD_IDX} shard_total=${SHARD_TOTAL} --ocl_task ${TASK} --max_step 1000
...
#  configs/p3/instance-bart0-base-ocl/extend.yaml \
#  --skip_before_eval --interval_eval 10 \
#  --templates postfix=_continual_lora_long_step30_adam_full_greedy_eval_mmlu_text-lr${LR}/${TASK}/${SHARD_IDX}_${SHARD_TOTAL}/ task=${TASK} shard_idx=${SHARD_IDX} shard_total=${SHARD_TOTAL} --ocl_task ${TASK} --max_step 1000
...
#  configs/mmlu/shards_text_dev.yaml configs/p3/instance-bart0-base-ocl/continual.yaml configs/p3/instance-bart0-base-ocl/distill_er_flan_t5.yaml \
#  configs/p3/instance-bart0-base-ocl/greedy.yaml configs/p3/instance-bart0-base-ocl/steps.yaml configs/p3/instance-bart0-base-ocl/lr${LR}.yaml configs/p3/instance-bart0-base-ocl/replay_n8.yaml \
#  configs/p3/instance-bart0-base-ocl/replay_freq1.yaml configs/p3/instance-bart0-base-ocl/replay_nstep.yaml configs/p3/instance-bart0-base-ocl/delay_opt.yaml \
