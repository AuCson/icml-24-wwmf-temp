...
do
  ...
  python instance_ocl_p3.py --config_files configs/p3/p3_default.yaml configs/p3/instance-bart0-base-ocl/vanilla_bg100_large_eval_mode.yaml \
   configs/p3/instance-bart0-base-ocl/continual.yaml configs/p3/instance-bart0-base-ocl/greedy.yaml configs/p3/ocl_dev.yaml configs/p3/instance-bart0-base-ocl/distill_er_bart0_coreset.yaml \
