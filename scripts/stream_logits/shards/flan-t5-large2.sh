...
for shard_idx in 1 2 3 4 5 6 7
do
...
--templates postfix=flan-t5-large-ft/shard_${shard_idx} task=mmlu shard_idx=${shard_idx} shard_total=8 --ocl_task mmlu --max_step 10 --skip_before_eval --monitor logit
done