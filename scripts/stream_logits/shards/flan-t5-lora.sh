...
--templates postfix=flan-t5-large-lora-lr1e-4-wpred/shard_${shard_idx} task=mmlu shard_idx=${shard_idx} shard_total=8 --ocl_task mmlu --max_step 20 --skip_before_eval --monitor logit preds
done