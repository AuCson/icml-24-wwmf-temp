...
configs/p3/instance-bart0-base-ocl/lr1e-6.yaml configs/p3/instance-bart0-base-ocl/delay_opt.yaml configs/p3/fpd/fpd_logits_defaults.yaml \
configs/p3/fpd/step100k.yaml configs/p3/fpd/bart_text_partial.yaml configs/p3/fpd/multi_token_kl.yaml configs/p3/fpd/margin_rw_multi_ts.yaml configs/p3/fpd/exact.yaml \
--templates postfix=_fpd_partial_thres/head/step100k/${task} task=${task} PART=head LR=lr1e-3 STEP=30 \
--ocl_task ${task}
