...
if __name__ == '__main__':
    ...
    for cmb in cmbs:
        ...
        cmd = 'python train_logit_predict.py --config_files configs/p3/p3_default.yaml configs/p3/instance-bart0-base-ocl/vanilla_bg100_large_eval_mode.yaml ' \
                  ...
                  'configs/p3/fpd/multi_token_kl.yaml configs/p3/fpd/step100k.yaml configs/p3/fpd/margin_rw.yaml configs/p3/fpd/lr_scale10.yaml configs/p3/fpd/bart_text_partial.yaml ' \
                  '--templates postfix=_fpd_logits_singlets_partial_mtl/step100k/{mtl_tasks} mtl_tasks={mtl_tasks} ' \
