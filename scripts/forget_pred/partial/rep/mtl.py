...
if __name__ == '__main__':
    ...
    for cmb in cmbs:
        ...
        pt_file = os.path.join('/home/xsjin/cl-analysis/runs/instance-p3-bart0-large/vanilla_bg100_fpd_reps_partial_mtl/step100k',tasks,'best_model.pt')
        ...
        cmd = 'python train_logit_predict.py --config_files configs/p3/p3_default.yaml configs/p3/instance-bart0-base-ocl/vanilla_bg100_large_eval_mode.yaml ' \
                  ...
                  'configs/p3/instance-bart0-base-ocl/delay_opt.yaml configs/p3/fpd/fpd_defaults.yaml configs/p3/fpd/step100k.yaml configs/p3/fpd/mtl_balanced.yaml configs/p3/fpd/bart_text_partial.yaml ' \
                  '--templates postfix=_fpd_reps_partial_mtl/step100k/{mtl_tasks} mtl_tasks={mtl_tasks} ' \
