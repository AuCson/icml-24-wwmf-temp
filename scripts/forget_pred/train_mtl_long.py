...
if __name__ == '__main__':
    ...
    for cmb in cmbs:
        ...
        cmd = 'python train_logit_predict.py --config_files configs/p3/p3_default.yaml configs/p3/instance-bart0-base-ocl/vanilla_bg100_large_eval_mode.yaml ' \
                  ...
                  'configs/p3/instance-bart0-base-ocl/delay_opt.yaml configs/p3/fpd/fpd_defaults.yaml configs/p3/fpd/step100k.yaml configs/p3/fpd/mtl.yaml ' \
                  '--templates postfix=_fpd_paired_mean_mlp_mtl/step100k/{mtl_tasks} mtl_tasks={mtl_tasks} --ocl_task debug --do_train'.format(mtl_tasks=tasks, LR='1e-6')
        print(cmd)
        os.system(cmd)