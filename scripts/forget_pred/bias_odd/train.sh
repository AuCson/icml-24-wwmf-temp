...
configs/p3/instance-bart0-base-ocl/delay_opt.yaml configs/p3/fpd/fpd_defaults.yaml configs/p3/fpd/prior_odd.yaml configs/p3/fpd/ckpt_2k.yaml --templates postfix=_fpd_paired_mean_mlp/step10k_bias_odd_steps/${task} task=${task} --ocl_task ${task} --do_train
done
