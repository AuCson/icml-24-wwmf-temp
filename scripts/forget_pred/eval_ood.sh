...
#for src_task in super_glue-cb super_glue-copa super_glue-rte super_glue-wsc.fixed anli hellaswag
#do
#for task in super_glue-cb super_glue-copa super_glue-rte super_glue-wsc.fixed anli hellaswag
#do
...
do
python train_logit_predict.py --config_files configs/p3/p3_default.yaml configs/p3/instance-bart0-base-ocl/vanilla_bg100_large_eval_mode.yaml configs/p3/instance-bart0-base-ocl/greedy.yaml configs/p3/instance-bart0-base-ocl/fix_label_bos.yaml configs/p3/instance-bart0-base-ocl/steps.yaml configs/p3/instance-bart0-base-ocl/lr${LR}.yaml \
configs/p3/instance-bart0-base-ocl/delay_opt.yaml configs/p3/fpd/fpd_logits_defaults.yaml configs/p3/fpd/load_model_dir.yaml --templates postfix=_fpd_logits_ood_eval/step10k/src_${src_task}/${task} load_model_dir=runs/instance-p3-bart0-large/vanilla_bg100_fpd_logits/step10k/${src_task} task=${task} --ocl_task ${task} --do_eval
done
done
