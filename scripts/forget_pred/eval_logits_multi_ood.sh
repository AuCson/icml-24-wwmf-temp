...
for src_task in super_glue-rte
do
for task in super_glue-wsc.fixed super_glue-wic anli hellaswag winogrande-winogrande_xl #super_glue-cb super_glue-copa super_glue-rte
do
python train_logit_predict.py --config_files configs/p3/p3_default.yaml configs/p3/instance-bart0-base-ocl/vanilla_bg100_large_eval_mode.yaml configs/p3/instance-bart0-base-ocl/greedy.yaml configs/p3/instance-bart0-base-ocl/fix_label_bos.yaml configs/p3/instance-bart0-base-ocl/steps.yaml configs/p3/instance-bart0-base-ocl/lr${LR}.yaml \
configs/p3/instance-bart0-base-ocl/delay_opt.yaml configs/p3/fpd/fpd_logits_defaults.yaml configs/p3/fpd/multi_token_kl.yaml configs/p3/fpd/step100k.yaml configs/p3/fpd/margin_rw.yaml configs/p3/fpd/load_model_dir.yaml --templates postfix=_fpd_logits_multi_kl_ood/step100k_margin_rw_tok/${src_task}/${task} task=${task} \
...
#do
#for task in super_glue-wsc.fixed super_glue-wic anli hellaswag winogrande-winogrande_xl
#do
#python train_logit_predict.py --config_files configs/p3/p3_default.yaml configs/p3/instance-bart0-base-ocl/vanilla_bg100_large_eval_mode.yaml configs/p3/instance-bart0-base-ocl/greedy.yaml configs/p3/instance-bart0-base-ocl/fix_label_bos.yaml configs/p3/instance-bart0-base-ocl/steps.yaml configs/p3/instance-bart0-base-ocl/lr${LR}.yaml \
