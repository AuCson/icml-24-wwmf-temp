...
configs/p3/fpd/fpd_defaults.yaml configs/mmlu/fpd_mmlu_text_partial.yaml configs/p3/flan_mmlu.yaml configs/p3/fpd/ce_weight_0.1.yaml configs/p3/fpd/lr1e-4.yaml configs/p3/fpd/lr_scale10.yaml configs/mmlu/t5-small.yaml configs/p3/fpd/step100k.yaml  \
--templates postfix=_fpd_reps_partial/head/step100k_margin_rw_sc10_ce0.1_lr1e-4_tok_small_baselr1e-4/mmlu task=mmlu PART=${PART} LR=${LR} STEP=${STEP} --ocl_task mmlu --do_train --eval_step 1000
done
