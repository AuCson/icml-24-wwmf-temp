...
#
  ...
  configs/p3/fpd/fpd_defaults.yaml configs/mmlu/fpd_mmlu_text_partial_xl.yaml configs/p3/flan_mmlu.yaml configs/p3/fpd/ce_weight_0.1.yaml configs/p3/fpd/lr1e-4.yaml configs/p3/fpd/lr_scale10.yaml configs/mmlu/t5-small.yaml configs/p3/fpd/step100k.yaml configs/p3/fpd/prior_odd.yaml  \
