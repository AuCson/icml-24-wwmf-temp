...
--templates postfix=_fpd_logits_partial_exact_small/head/step100k_margin_rw_sc10_lr1e-4_tok_small_baselr1e-3_fix/mmlu task=mmlu PART=${PART} LR=${LR} STEP=${STEP} --ocl_task mmlu --do_train --eval_step 1000
done
