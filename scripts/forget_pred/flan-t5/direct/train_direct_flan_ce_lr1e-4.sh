...
configs/p3/fpd/logit_direct_ce.yaml configs/p3/fpd/lr1e-4.yaml configs/p3/fpd/lr_scale10.yaml --templates postfix=_fpd_flan_direct_ce_1e-4/ task=mmlu --ocl_task mmlu \
--do_train