...
#--templates postfix=_fpd_rep_multi/step100k_lr1e-4_sc10_ce0.03_tok_small/mmlu task=mmlu --ocl_task mmlu --do_train --eval_step 1000
#done
...
--templates postfix=_fpd_rep_multi/step100k_lr1e-4_ce0.1_prior_odd_sc10_tok_small_baselr1e-4/mmlu task=mmlu --ocl_task mmlu --do_train --eval_step 1000
done