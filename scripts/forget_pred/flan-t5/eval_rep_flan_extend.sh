...
configs/p3/fpd/fpd_defaults.yaml configs/mmlu/fpd_mmlu_text_long.yaml configs/p3/fpd/lr1e-4.yaml configs/p3/fpd/lr_scale10.yaml configs/mmlu/t5-small.yaml configs/p3/fpd/step100k.yaml \
configs/p3/fpd/ce_weight_0.03.yaml configs/p3/fpd/prior_odd.yaml \
--templates postfix=_fpd_rep_multi_long/step100k_lr1e-4_sc10_ce0.03_prior_odd_tok_small/mmlu task=mmlu \
...
--ocl_task mmlu --do_eval --eval_step 1000
done