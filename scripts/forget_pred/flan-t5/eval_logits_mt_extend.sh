...
configs/p3/fpd/fpd_logits_defaults.yaml configs/mmlu/fpd_mmlu_text_long.yaml configs/p3/fpd/lr1e-4.yaml configs/p3/fpd/lr_scale10.yaml configs/mmlu/t5-small.yaml configs/p3/fpd/multi_token_kl.yaml configs/p3/fpd/margin_rw_multi_ts.yaml configs/p3/fpd/step100k.yaml \
