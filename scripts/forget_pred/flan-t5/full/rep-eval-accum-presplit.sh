...
configs/p3/fpd/ce_weight_0.1.yaml configs/p3/fpd/lr_scale10.yaml configs/p3/fpd/step100k.yaml configs/p3/fpd/accum4.yaml \
--templates postfix=_fpd_rep_multi_full/mmlu_accum4 task=mmlu --ocl_task mmlu --eval_step 1000 --do_eval