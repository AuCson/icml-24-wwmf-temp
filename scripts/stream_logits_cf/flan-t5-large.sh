...
configs/p3/instance-bart0-base-ocl/delay_opt.yaml configs/stream.yaml  configs/counterfact/stream_cf.yaml \
--templates postfix=flan-t5-large-ft-corr task=mmlu shard_idx=0 shard_total=8 --ocl_task mmlu --max_step 100 --monitor logit