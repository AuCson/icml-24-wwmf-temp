...
configs/p3/instance-bart0-base-ocl/delay_opt.yaml configs/stream.yaml configs/subset_exps/subset_mmlu.yaml \
--templates postfix=flan-t5-large-ft-mixed task=mmlu --ocl_task mmlu --max_step 1000 --skip_before_eval --monitor logit