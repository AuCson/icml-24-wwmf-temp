...
for task in ocl_tasks:
    ...
    os.system(
        "python stream_ocl.py --config_files configs/p3/p3_default.yaml configs/p3/p3_alt.yaml configs/p3/instance-bart0-base-ocl/p3_alt_abl.yaml \
         ...
         configs/p3/instance-bart0-base-ocl/delay_opt.yaml configs/stream.yaml --templates postfix=alt-p3-once-abl/flan-t5-large-ft/{task} \
